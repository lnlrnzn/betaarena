...
import { AGENTS, SOL_BASELINE, TIME_RANGES } from "@/lib/constants";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const timeRange = TIME_RANGES[range as keyof typeof TIME_RANGES] || TIME_RANGES["24H"];
    ...
    const { data: solPrices, error: solError } = await supabase
